  ...
  return (
    <div className="space-y-4 animate-in fade-in duration-500">
      <div className="flex items-center justify-between mb-2">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-white/90">Goals & Targets</h1>
          <p className="text-xs text-white/40 mt-0.5 uppercase tracking-widest">Objectives Tracking</p>
        </div>
      </div>
      ...
      <div className="bg-[#0a0a0a] border border-white/[0.04] p-12 rounded-lg flex flex-col items-center justify-center text-center min-h-[300px]">
        ...
        <h2 className="text-lg font-bold text-white/90 mb-1">Goals Engine Coming Soon</h2>
        <p className="text-xs text-white/40 max-w-md mx-auto mb-6 leading-relaxed">
          Track consistency streaks, profit targets, max daily loss limits, and monitor your progress automatically based on your journal.
        </p>
